        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CandidateProfileProfileID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CvFiles", x => x.CVID);
                    table.ForeignKey(
                        name: "FK_CvFiles_CandidateProfiles_CandidateProfileProfileID",
                        column: x => x.CandidateProfileProfileID,
                        principalTable: "CandidateProfiles",
                        principalColumn: "ProfileID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployerID1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_Employers_EmployerID1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CandidateProfileProfileID = table.Column<int>(type: "int", nullable: true),
                    JobPostJobID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Applications", x => x.AppID);
                    table.ForeignKey(
                        name: "FK_Applications_CandidateProfiles_CandidateProfileProfileID",
                        column: x => x.CandidateProfileProfileID,
                        principalTable: "CandidateProfiles",
                        principalColumn: "ProfileID");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Applications_JobPosts_JobPostJobID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SavedJobs_JobPosts_JobPostJobID",
                        column: x => x.JobPostJobID,
                        principalTable: "JobPosts",
                        principalColumn: "JobID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_CandidateProfileProfileID",
                table: "Applications",
                column: "CandidateProfileProfileID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_JobPostJobID",
                table: "Applications",
                column: "JobPostJobID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CvFiles_CandidateProfileProfileID",
                table: "CvFiles",
                column: "CandidateProfileProfileID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedJobs_JobPostJobID",
                table: "SavedJobs",
                column: "JobPostJobID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_EmployerID1",
                table: "Transactions",
                column: "EmployerID1");
