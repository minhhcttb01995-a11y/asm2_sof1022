...
public partial class AppDbContext : DbContext
{
    ...
    public virtual DbSet<JobModerationLog> JobModerationLogs { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<JobModerationLog>(entity =>
        {
            entity.ToTable("JobModerationLog");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.ContentHash).HasMaxLength(64).IsRequired();
            entity.Property(e => e.Recommendation).HasMaxLength(20).IsRequired();
            entity.Property(e => e.ModulesJson).HasColumnType("nvarchar(max)");

            // 1 JobPost chỉ giữ 1 log mới nhất -> Unique để Upsert theo JobId
            ...
            entity.HasOne(e => e.Job)
                ...
                .HasConstraintName("FK_JobModerationLog_JobPosts");
        });
