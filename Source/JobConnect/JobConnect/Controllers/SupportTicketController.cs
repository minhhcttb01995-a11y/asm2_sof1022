...
// [FIX-LOGIC] Trước đây [Authorize(Roles = "Staff,Admin")] cho Admin vào xem được danh
// sách ticket, nhưng Assign/Respond/Resolve/Close đều cần tra "staff.Id" từ bảng Staff
// (Admin không có dòng nào ở đó) — nên với Admin, các nút này chỉ redirect âm thầm mà
// KHÔNG làm gì cả, không báo lỗi gì, rất dễ gây hiểu lầm là "đã xử lý". Hệ thống cũng
// chưa có UI/cột dữ liệu riêng để Admin tự xử lý ticket (vd: AssignedToAdminId) nên thu
// hẹp lại chỉ cho Staff là an toàn nhất hiện tại.
