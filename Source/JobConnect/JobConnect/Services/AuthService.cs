...
public class AuthService : IAuthService
{
    ...
    public async Task<User?> LoginAsync(string email, string password)
    {
        ...
        // LƯU Ý: Không kiểm tra trạng thái khóa/cấm/xóa mềm ở đây nữa.
        // Nếu chặn tại đây (trả về null), AccountController sẽ không phân biệt được
        // giữa "sai email/mật khẩu" và "tài khoản bị khóa", vì cả hai đều trả về null.
        // Việc kiểm tra trạng thái (BlocksLogin, DeletedAt...) do AccountController.Login
        // đảm nhiệm qua IsStatusBlockingLoginAsync, để có thể hiển thị đúng thông báo
        // "Tài khoản của bạn đang ở trạng thái không được phép đăng nhập".
        return user;
    }
