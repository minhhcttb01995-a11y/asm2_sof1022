...
namespace JobConnect.Migrations
{
    ...
    [Migration("20260627012211_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobConnect.Models.CompanyReview", b =>
                {
                    ...
                    b.HasIndex("AppID", "ReviewType")
                        .IsUnique()
                        .HasFilter("[ReviewType] IS NOT NULL");
            ...
            modelBuilder.Entity("JobConnect.Models.CompanyReview", b =>
                {
                    ...
                    b.HasOne("JobConnect.Models.User", "Reviewee")
                        .WithMany()
                        .HasForeignKey("RevieweeID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("JobConnect.Models.User", "Reviewer")
                        .WithMany()
