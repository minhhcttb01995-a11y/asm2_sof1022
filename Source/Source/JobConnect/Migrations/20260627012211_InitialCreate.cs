        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewType = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsAnonymous = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => x.CompanyReviewID);
                    table.ForeignKey(
                        name: "FK_Reviews_Applications_AppID",
                        column: x => x.AppID,
                        principalTable: "Applications",
                        principalColumn: "AppID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_AppID_ReviewType",
                table: "Reviews",
                columns: new[] { "AppID", "ReviewType" },
                unique: true,
                filter: "[ReviewType] IS NOT NULL");
