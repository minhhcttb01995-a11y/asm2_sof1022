...
public class AppDbContext : DbContext
{
    ...
    // ĐÃ SỬA: Đổi kiểu dữ liệu trong DbSet thành CompanyReview
    public DbSet<CompanyReview> Reviews => Set<CompanyReview>();
    ...
    protected override void OnModelCreating(ModelBuilder mb)
    {
        ...
        // ĐÃ SỬA: Đồng bộ toàn bộ mb.Entity về class mới CompanyReview
        mb.Entity<CompanyReview>()
          .HasOne(r => r.Application)
          .WithMany()
          .HasForeignKey(r => r.AppID)
          .OnDelete(DeleteBehavior.Cascade);

        // (Nếu các quan hệ Reviewer/Reviewee này thuộc về logic cũ, chỉnh lại cho chạy ổn định)
        mb.Entity<CompanyReview>()
          .HasOne(r => r.Reviewer)
          .WithMany()
        ...
        // Mỗi app chỉ cho phép 1 đánh giá mỗi chiều
        mb.Entity<CompanyReview>()
          .HasIndex(r => new { r.AppID, r.ReviewType })
          .IsUnique();
    }
}