    ...
    public async Task<(bool Success, string? Error, int RecordCount)> DeleteAsync(int id)
    {
        ...
        switch (entity.EntityType)
        {
            ...
            case "JobPost":
                ...
                break;
            // [FIX] Đã bỏ case "Company" riêng vì StatusEntityTypes.Company giờ trỏ cùng giá trị
            // "Employer" (xem Models/StatusCatalog.cs) — giữ 2 case trùng chuỗi sẽ lỗi biên dịch.
            case "BlogPost":
