...
public class AdminController : Controller
{
    ...
    public async Task<IActionResult> PermanentDeleteUser(int userId)
    {
        ...
        {
            TempData["Error"] = $"Không thể xóa vĩnh viễn tài khoản {user.Email} vì vẫn còn dữ liệu liên quan (đơn ứng tuyển, tin tuyển dụng, tin nhắn...). Hãy xử lý/xóa các dữ liệu đó trước.";
            return RedirectBackOrTo("Users");
        }
    ...
    public async Task<IActionResult> PermanentDeleteCompany(int id)
    {
        ...
        {
            TempData["Error"] = $"Không thể xóa vĩnh viễn công ty \"{name}\" vì vẫn còn dữ liệu liên quan (đơn ứng tuyển, tin nhắn...). Hãy xử lý dữ liệu đó trước.";
            return RedirectBackOrTo("Companies");
        }
